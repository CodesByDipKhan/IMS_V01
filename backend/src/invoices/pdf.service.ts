...
export class PdfService {
  async generateInvoicePdf(
    ...
    // Format: "Current Time" e.g., "09:27 AM"
    ...
    // Bank detail rows if payment method is bank/card/mobile
